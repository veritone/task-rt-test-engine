        ...
        stages
        {
            ...
            stage("Approve \'STAGE\'")
            {
                when {
                    ...
                    allOf {
                        anyOf {
                            expression { BRANCH_NAME.trim().toLowerCase().startsWith("hotfix/") }
                            expression { BRANCH_NAME == 'master' }
                        }
                        expression { VERITONE_ENVIRONMENT != 'GovCloud' }
                ...
                steps {
                    promotionApproval(72, GIT_REPO_NAME, ENVIRONMENT, "veritone*StageApprovers")
                }
